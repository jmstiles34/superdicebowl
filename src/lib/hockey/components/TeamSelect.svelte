<script lang="ts">
	...
	import { teamsData } from '$lib/hockey/data/data.json';
...
<style>
	...
	.logo-area img { width: 8rem; height: 8rem; object-fit: contain; filter: drop-shadow(0 0 6px rgba(255, 255, 255, 0.5)); }
