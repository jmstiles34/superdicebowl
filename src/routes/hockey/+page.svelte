<script lang="ts">
	...
	import { beginDisabled } from '$lib/hockey/utils/game';
	...
	import TeamSelect from '$lib/hockey/components/TeamSelect.svelte';
	...
	const beginGame = () => {
		...
		sleep(1000).then(() => goto('/hockey/game'));
	};
</script>

<main>
	<h1>Super Dice Hockey</h1>
	...
	<div class="begin-row">
		<div class="score-select">
			...
			<select id="winScore" class="win-score" value={settings.winScore} onchange={handleScoreChange}>
