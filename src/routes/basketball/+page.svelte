<script lang="ts">
	...
	import { beginDisabled } from '$lib/basketball/utils/game';
	...
	import TeamSelect from '$lib/basketball/components/TeamSelect.svelte';
	...
	const beginGame = () => {
		...
		sleep(1000).then(() => goto('/basketball/game'));
	};
</script>

<main>
	<h1>Super Dice Basketball</h1>
